 ...
 */
include_once "google-api-php-client-12-13-14/examples/templates/base.php";
session_start();

require_once ('google-api-php-client-12-13-14/autoload.php');
...
$client->setScopes($readwrite_scope);
