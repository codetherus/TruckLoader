...
/*
  ...
  Truckstop.com offers web services to completely replace
  the loads list and another to do adds, updates and deletes.
  We are using the latter because the customer spreadsheets
  contain previous and new loads.
  
  This page extracts the spreadsheet into a MySql table
  and does the truckstop upload followed by a redirect
  to the DAT upload page.

*/
require_once("commons.php"); //System config/commons
//Load the excel parsing tools
