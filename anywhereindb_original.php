   ...
   ))
{
	...
	// @abstract  it will show the login prompt
					...
					if(isset($_REQUEST['error_message'])){echo '<span style="color:red;">'.$_REQUEST['error_message'].'</span>';} 
					?>
...
//@note if you have querry, need, idea, help; fell free to contact happy56@gmail.com