...
/*
  ...
  09-13-2012 Added selector for company vs broker trucks
...
//Trying uot the Readbean database objects class.
require("rb.php");

R::setup("mysql:host=localhost;dbname=jake",'root','');
