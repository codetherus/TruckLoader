		jQuery(document).ready(function(){
			$("#thesplitter").split({orientation: 'vertical', position: '50%'});
			initialize();
		})
	...
	var timerId; //The id of the page refresh setTimeout
	...
	function initialize() {
	  var mapOptions = {
	   ...
	   trackmap = new google.maps.Map(document.getElementById('track-map-canvas'), mapOptions);
	...
	//xajax_RefreshRequest call callback	
	//The parameters are the json objects
