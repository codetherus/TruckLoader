...
<label>Home Office:</label> <input id='home_office' name='home_office' value='{$home_office}'/><br/><br/>
...
<div id='centercolumn' style='display:inline-block;width:32%; Float:left;'>
...
<label>Office Numbers:</label> <input id='office_numbers' name='office_numbers' value='{$office_numbers}'/><br/>
...
<textarea style='margin-left: 30px;' rows='5' cols='20' id='load_options' name='load_options' >{$load_options}</textarea><br/>
<label style="width: 115px;">Recent Viewers:</label>
{$user_list}
</div>
</div>
</form>
