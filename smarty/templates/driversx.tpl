...
<body> 
 <!-- Navigation -->
  ...
  <nav class="top-bar" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
        ...
        <li class="divider"></li>
        <li><a href="#">Radius Search</a></li>
        <li class="divider"></li>
        <li><a href="#">Drivers</a></li>
        <li class="divider"></li>
        <li><a href="#">Today's Loads</a></li>
        <li class="divider"></li>
        <li><a href="#">Help</a></li>
        <li class="divider"></li>
  ...
  <div class="large-6 columns">
    <dl class="sub-nav">
    <dd><a href="#">Read</a></dd>
    <dd><a href="#">Update</a></dd>
    <dd><a href="#">Delete</a></dd>
    <dd><a href="#">Create</a></dd>
    </dl>
  </div>
  <div class="large-3 columns">&nbsp;</div>
  </div>
  ...
  <footer class="row">
    ...
    <div class="large-6 columns">
        <h6 class="subheader">
        <small>&copy; {$footeryear} {$footertext}</small>
        </h6>
    </div>
        <div class="large-3 columns"&nbsp;></div>
    </div>
  ...
  <script>
  document.write('<script src=foundation5/js/vendor/' +
