...
<li><a href="#" rel="dropmenu2">Themes</a></li>
{if $admin}
...
<ul>
<li><a href="#" onclick="xajax_theme('truckloaderv2')">Default</a></li>
<li><a href="#" onclick="xajax_theme('blue')">Blue</a></li>
<li><a href="#" onclick="xajax_theme('rust')">Rust</a></li>
</div>
