...
<label>Home Office:</label> <input id='home_office' name='home_office' value='{$home_office}' tabindex='6'/><br/><br/>
...
<label>Office Number:</label> <input id='office_numbers' name='office_numbers' value='{$office_numbers}' tabindex='12'/><br/><br/>
