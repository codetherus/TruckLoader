...
$myObj->myValue='wrong';
$requestInstanceMethod = $xajax->register(XAJAX_FUNCTION, array("testForm",$myObj,"testInstanceMethod"));

$requestInstanceMethod->setParameter( 0, XAJAX_FORM_VALUES, 'testForm1' );
$requestClassMethod = $xajax->register(XAJAX_FUNCTION,array("testForm2","myObjectTest",	"testClassMethod"	));
